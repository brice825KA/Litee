...
<template>
    <div class="space-y-5 items-center justify-center bg-[#F7FAFB00] pl-30 pr-15">
        ...
        <div class="">
            <p class="font-family-[Work Sans] font-[300] text-[24px] leading-[152%] text-[#000000]">Facturation claire et simple. Dites adieu aux<br>
        ...
        <div class="">
            ...
            <div class="bg-blue-300 w-[514px] h-[813px] t-[541px] l-[195px] shadow-100">
                ...
                <div class="justify-center items-center ">
                    ...
                    <div class="flex justify-center items-center "><button class="w-[172px] h-[55px] t-[1233px] l-[377px] rounded-[27.5px] bg-[#FA4A4D] font-family-[Work Sans] font-[300] text-[18px] leading-[100%] text-[#FFFFFF]">Inscription</button></div>
                </div>
            </div>
        </div>
        <div class="">
