...
<template>
    <div class="newsletter-wrapper bg-[#FFFFFF] flex w-full max-w-[1500px] mx-auto h-auto min-h-[134px] px-6 md:px-12 lg:px-16 pt-10 pb-8 mb-5 gap-8 md:gap-12 lg:gap-20 items-center justify-center">
